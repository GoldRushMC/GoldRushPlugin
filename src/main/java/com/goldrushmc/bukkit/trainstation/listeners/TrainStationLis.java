...
/**
 * Currently, all this class really does is adds and removes {@link Player}s from the {@link com.goldrushmc.bukkit.trainstation.TrainStation#visitors} list.
 *
 * @author Diremonsoon
 */
public class TrainStationLis extends DefaultListener {
    ...
    /**
     * Handles the {@link StationSignEvent} for each types.
     *
     * @param event
     */
    @EventHandler
    ...
    public void onTrainNextToDepart(TrainFullStopEvent event) {
        ...
        if (station.getType().equals(StationType.STORAGE_TRANS)) {
            ...
            //We check to see if the trainstation has already stopped. if it has, we don't want to bug it!
            ...
            //We need to check the middle of the trainstation, to determine what type it is.
