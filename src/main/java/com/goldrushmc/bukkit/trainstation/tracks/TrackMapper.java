 ...
 * the types can know where they go and what direction they go in.
 *
 * @author Diremonsoon
 *
 */
public class TrackMapper {
    ...
    public static Map<TrackMapper, List<BlockFinder>> listOfMaps = new HashMap<>();
    //Most west rail is south, most north rail is west.
    //Most east rail is north, most south rail is east.
    public List<IDirectedMap> maps = new ArrayList<>();
