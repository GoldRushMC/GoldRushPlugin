...
public class TrainStationListCommand extends CommandDefault {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if(!sender.hasPermission(GoldRushPerms.LIST)) { deny(sender); return true; } 
		
		if(TrainStation.getTrainStations().isEmpty()) { sender.sendMessage("There are no train stations currently in existence."); return true; }
